...
namespace octo
{
	...
	LexicalTree<C, T, DefaultValue, RootValue>::LexicalTree() :
	...
	template <class C, class T, T DefaultValue, T RootValue>
	void		LexicalTree<C, T, DefaultValue, RootValue>::exportDotLabel(ConstNodePtr node, OStream& os)
	{
	...
	template <class C, class T, T DefaultValue, T RootValue>
	void	LexicalTree<C, T, DefaultValue, RootValue>::exportDot(OStream& os, String const& graphName)const
	{
	...
	template <class C, class T, T DefaultValue, T RootValue>
	void	LexicalTree<C, T, DefaultValue, RootValue>::addWord(String const& word, T const& value)
	{
		if (word.empty())
			return;
		auto	it = word.cbegin();
	...
	template <class C, class T, T DefaultValue, T RootValue>
	void	LexicalTree<C, T, DefaultValue, RootValue>::completeWord(String const& beginStr, std::vector<String>& results)const
	{
	...
	template <class C, class T, T DefaultValue, T RootValue>
	void	LexicalTree<C, T, DefaultValue, RootValue>::getWords(std::vector<String>& results)const
	{
		m_root->getWords(results);
	}

	template <class C, class T, T DefaultValue, T RootValue>
	bool	LexicalTree<C, T, DefaultValue, RootValue>::contains(String const& word)const
	{
		ConstNodePtr	current = m_root;
		auto			it = word.begin();
	...
	template <class C, class T, T DefaultValue, T RootValue>
	typename LexicalTree<C, T, DefaultValue, RootValue>::NodePtr	LexicalTree<C, T, DefaultValue, RootValue>::addLetter(NodePtr& current, C letter, T const& value)
	{
		NodePtr	next;
	...
	template <class C, class T, T DefaultValue, T RootValue>
	typename LexicalTree<C, T, DefaultValue, RootValue>::NodePtr	LexicalTree<C, T, DefaultValue, RootValue>::addLetter(NodePtr& current, C letter)
	{
		NodePtr	next;
