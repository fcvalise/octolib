...
/*   Updated: 2015/03/30 18:08:05 by irabeson         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
	...
	void	pushFront(sf::Vector2f const& position)
	{
		...
		m_beforeBeginPoint = m_points.front();
		m_afterEndPoint = m_points.back();
	}
	...
	sf::Vector2f	compute(float t)const
	{
		...
		sf::Vector2f const&	p0 = getPoint(intIndex - 3);
		sf::Vector2f const&	p1 = getPoint(intIndex - 2);
		sf::Vector2f const&	p2 = getPoint(intIndex - 1);
		sf::Vector2f const&	p3 = getPoint(intIndex);
