...
#include "../../CommonWidgets/ColorEditor.hpp"
...
QT_MOC_LITERAL(4, 41, 5), // "color"
QT_MOC_LITERAL(5, 47, 15), // "onEditorChanged"
QT_MOC_LITERAL(6, 63, 8) // "editorId"

    },
    "ColorEditor\0colorChanged\0\0onColorChanged\0"
    "color\0onEditorChanged\0editorId"
};
...
void ColorEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onEditorChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ColorEditor::*_t)(QColor );
...
const QMetaObject ColorEditor::staticMetaObject = {
    { &QTabWidget::staticMetaObject, qt_meta_stringdata_ColorEditor.data,
...
// SIGNAL 0
void ColorEditor::colorChanged(QColor _t1)
{
