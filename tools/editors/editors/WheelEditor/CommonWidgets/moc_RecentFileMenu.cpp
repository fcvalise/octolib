/****************************************************************************
** Meta object code from reading C++ file 'RecentFileMenu.hpp'
**
...
#include "../../CommonWidgets/RecentFileMenu.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'RecentFileMenu.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_RecentFileMenu_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RecentFileMenu_t qt_meta_stringdata_RecentFileMenu = {
    {
QT_MOC_LITERAL(0, 0, 14), // "RecentFileMenu"
QT_MOC_LITERAL(1, 15, 11), // "fileClicked"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 8), // "filePath"
QT_MOC_LITERAL(4, 37, 7), // "addFile"
QT_MOC_LITERAL(5, 45, 10), // "removeFile"
QT_MOC_LITERAL(6, 56, 5) // "clear"

    },
    "RecentFileMenu\0fileClicked\0\0filePath\0"
    "addFile\0removeFile\0clear"
};
...
void RecentFileMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->addFile((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->removeFile((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (RecentFileMenu::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RecentFileMenu::fileClicked)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject RecentFileMenu::staticMetaObject = {
    { &QMenu::staticMetaObject, qt_meta_stringdata_RecentFileMenu.data,
      qt_meta_data_RecentFileMenu,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void RecentFileMenu::fileClicked(const QString & _t1)
{
